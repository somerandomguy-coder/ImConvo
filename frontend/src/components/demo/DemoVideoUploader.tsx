    ...
    <div className="w-full rounded-xl border border-border bg-card p-5 shadow-sm">
      {!file ? (
        <div className="flex flex-col items-start gap-3">
          <p className="text-sm text-muted">Upload a video for inference.</p>
          <input
            ref={inputRef}
            type="file"
            ...
            className="block w-full text-sm text-foreground
              ...
              hover:file:bg-accent-hover file:cursor-pointer file:transition-colors"
          />
        </div>
      ) : (
